<?php 
@include('login/system/login.php'); 
        ...
        <div class="collapse navbar-collapse" id="probootstrap-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <?php }else{ ?>
                ...
                <li class="nav-item cta-btn ml-xl-2 ml-lg-2 ml-md-0 ml-sm-0 ml-0"><a class="nav-link" href="<?php if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] == true) { if($level == "A"){ echo "users/admin/";}else{ echo "users/member/";} }else{ echo "login/"; }?>" target="_blank"><span class="pb_rounded-4 px-4">LOGIN</span></a></li>
            <?php }?>
          </ul>
        </div>
      </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="text-center" style="color: red;">โปรดเลือกประเภท</h4>
                <center>
                  <a type="button" style="color: white;" class="btn btn-primary" href="finder/?page=report">ตามหาของหาย</a>
                  <a type="button" style="color: white;" class="btn btn-primary" href="finder/?page=anouce">ของหายที่กำลังค้นหา</a> 
              </center>
            </div>
        </div>
    </div>
