    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <center>
                  <a type="button" style="color: white;" class="btn btn-primary" href="?page=report">ประกาศตามหาของหาย</a>
                  <a type="button" style="color: white;" class="btn btn-primary" href="?page=anouce">ประกาศตามเจอของหาย</a> 
              </center>
            </div>
        </div>
    </div>
